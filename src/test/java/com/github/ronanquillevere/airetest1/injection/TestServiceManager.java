...
public class TestServiceManager
{
   ...
   public void testInjection() throws Exception
   {
      ...
      PersonsResource helloRessource = injector.getInstance(PersonsResource.class);
      assertThat(helloRessource).isNotNull();

      assertThat(helloRessource.getPerson().getName()).isEqualTo("ronan");
   }
}
